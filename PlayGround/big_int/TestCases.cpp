...
TEST(BigInt, Addition) {
    ...
    string s1 = (string)b;
    string expected1 = "10000000000000000000";

    string s2 = (string)c;
    string expected2 = "19999999999999999999";

    string s3 = (string)d;
    string expected3 = "10000000000000000001";
...
TEST(BigInt, Mul) {
    ...
    string s2 = (string)a;
    string expected2 = "5502622159812088949850305428800254892961651752960000000000";

    ASSERT_EQ(0, s1.compare(expected1));
    ASSERT_EQ(0, s2.compare(expected2));
}

TEST(BigInt, Compund_Operator) {
    ...
    BigInt f("-987654321");
    e += f;
    EXPECT_EQ(e.toString(), "-1111111110");

    BigInt c("987654321");
    BigInt d("123456789");
    c -= d;
    EXPECT_EQ(c.toString(), "864197532");
}
